    ...
    <section class="mb-40 font-sora">
      ...
      <div class="container mx-auto px-6 md:px-12 xl:px-32">
        <div class="text-center text-white">
          <div class="block rounded-lg shadow-lg px-6 py-12 md:px-10 lg:-mr-14 dark:glassmorphism backdrop-blur-lg backdrop-opacity-75 backdrop-contrast-75 shadow-md md:py-16 hero-entreprise-cta dark:glassmorphism">
