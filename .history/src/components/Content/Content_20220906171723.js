      ...
      <div class="grid xl:grid-cols-2 flex items-center">
        <div class="mb-12">
          <div class="block rounded-lg shadow-lg px-6 py-12 md:px-10 lg:-mr-14 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md">
            ...
            Mon objectif est d'atteindre les vôtres ! <br/><br/>Les programmes qui vous sont proposés sont totalement individualisés et adaptés à vos objectifs et besoins. Qu'ils soient de performance, esthétique ou encore de santé, nous atteindrons ces objectifs de la manière la plus optimale qui soit.
            </p>
