...
const Content = () => {
  ...
  return (
    <section class="my-32 text-gray-800" id='a-propos'>
    <div class="container mx-auto xl:px-32 text-center lg:text-left w-[80%] md:w-full">
      <div class="grid md:grid-cols-2 flex items-center">
        <div class="mb-12 lg:mb-0">
          <div class="block rounded-lg shadow-lg px-6 py-12 md:px-12 lg:-mr-14 glassmorphism">
        ...
        <div>
          <img src={Hero} class="w-full rounded-lg shadow-lg"
            alt="" />
        </div>
      </div>
    </div>
