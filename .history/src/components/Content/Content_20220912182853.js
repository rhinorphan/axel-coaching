  ...
  return (
    ...
    <div class="container mx-auto xl:px-3 text-center xl:text-left w-[80%] xl:w-full">
      <div class="grid xl:grid-cols-2 flex items-center">
        <div class="mb-12 text-justify" id='a-propos'>
          <div class="block rounded-lg shadow-lg px-6 py-12 md:px-10 lg:-mr-14 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md">
            <h2 class="text-3xl font-bold mb-6 text-center">A la rencontre du <span className="text-[#E73725] mr-2">Coach</span>🥇</h2>
            ...
            text-[#E73725] text-sm xl:text-xs font-semibold lg:justify-between mb-6 mx-auto">
        ...
        <div>
          <img src={Hero} class="w-full rounded-lg hero2 shadow-md -z-1 border-4 border-[#E73725]"
            alt="" />
        </div>
      </div>
    </div>
