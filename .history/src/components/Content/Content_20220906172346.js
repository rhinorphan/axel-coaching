  ...
  return (
    ...
    <div class="container mx-auto xl:px-3 text-center xl:text-left w-[80%] xl:w-full">
      <div class="grid xl:grid-cols-2 flex items-center">
        <div class="mb-12">
          <div class="block rounded-lg shadow-lg px-6 py-12 md:px-10 lg:-mr-14 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md" id='a-propos'>
            ...
            Je m'appelle <span className="font-bold">Axel</span>, coach sportif diplômé, disponible sur Bourgoin-Jallieu et en région lyonnaise. <br/> J'ai une Licence STAPS spécialité entrainement sportif, ainsi qu'un Master en préparation du sportif : aspects <span className="font-bold">Physique</span>, <span className="font-bold">Mentaux</span> et <span className="font-bold">Ré-athlétisation</span>. 
            Mon objectif est d'atteindre les vôtres ! <br/>Les programmes qui vous sont proposés sont totalement <span className="font-bold">individualisés</span> et <span className="font-bold">adaptés</span> à vos objectifs et besoins. Qu'ils soient de performance, esthétique ou encore de santé, nous atteindrons ces objectifs de la manière la plus optimale qui soit.
            </p>

            <div class="flex flex-col justify-around md:flex-row
            text-gray-800 text-sm xl:text-xs font-semibold dark:text-gray-400 lg:justify-between mb-6 mx-auto">
