      ...
      <div class="grid xl:grid-cols-2 flex items-center">
        <div class="mb-12" id='a-propos'>
          <div class="block rounded-lg shadow-lg px-6 py-12 md:px-10 lg:-mr-14 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md">
            <h2 class="text-3xl font-bold mb-6">À la rencontre du <span className="text-[#A04738] mr-2">Coach</span>🥇</h2>
            ...
            text-[#A04738] text-sm xl:text-xs font-bold lg:justify-between mb-6 mx-auto">
        ...
        <div>
          <img src={Hero} class="w-[430px] md:w-[600px] rounded-lg hero2 shadow-md -z-1 mx-auto"
            alt="" />
        </div>
      </div>
    </div>
