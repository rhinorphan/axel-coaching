      ...
      <div class="grid lg:grid-cols-2 flex items-center">
        <div class="mb-12 lg:mb-0">
          <div class="block rounded-lg shadow-lg px-6 py-12 md:px-12 lg:-mr-14 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md">
            ...
            Je m'appelle Axel, coach sportif diplômé sur Bourgoin-Jallieu et plus en région lyonnaise ! J'ai une Licence STAPS spécialité entrainement sportif, ainsi qu'un Master STAPS EOPS (Bac + 5). 
