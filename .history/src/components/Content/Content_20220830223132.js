    ...
    <div class="container mx-auto xl:px-32 text-center lg:text-left w-[80%] lg:w-full">
      <div class="grid lg:grid-cols-2 flex items-center">
        <div class="mb-12 lg:mb-0">
          <div class="block rounded-lg shadow-lg px-6 py-12 md:px-12 lg:-mr-14 dark:glassmorphism bg-gray-300 shadow-md">
            <h2 class="text-3xl font-bold mb-6">A la rencontre du Coach</h2>
            <p class="dark:text-gray-200 text-gray-600 mb-6 pb-2 lg:pb-0">
