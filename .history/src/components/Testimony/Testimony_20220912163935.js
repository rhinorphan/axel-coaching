    ...
    <section class="w-full my-28" id="temoignage">
      <div class="px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
        ...
        <figure class="max-w-screen-md mx-auto">
              <svg class="h-12 mx-auto mb-3 text-gray-600 dark:text-gray-600" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <figcaption class="flex items-center justify-center mt-6 space-x-3">
                  ...
                  <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                      ...
                      <div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-700">CEO at Google</div>
                  </div>
              </figcaption>
          </figure>
          <figure class="max-w-screen-md mx-auto">
