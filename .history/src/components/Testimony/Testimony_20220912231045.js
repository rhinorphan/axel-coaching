    ...
    <section className="w-full my-28" id="temoignage">
      <div className="px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <p className="mb-5 font-light sm:text-xl dark:text-gray-200 text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec mauris id quam pharetra sodales et ut justo. Duis sit amet felis dolor. </p>
        </div>
        ...
        <figure className="max-w-screen-md mx-auto">
              ...
              <blockquote>
                  <p className="text-2xl font-medium text-gray-900 dark:text-white">"Vivamus at libero ullamcorper, porttitor felis eget, malesuada quam. Orci varius natoque penatibus et magnis dis parturient montes, nascetur."</p>
              </blockquote>
