          ...
          <figure className="max-w-screen-md mx-auto">
              ...
              <figcaption className="flex items-center justify-center mt-6 space-x-3">
                  <div className="flex items-center divide-x-2 divide-[#E73725]">
                      ...
                      <div className="pl-3 text-sm font-semibold text-[#E73725]">Mère d'un jeune rugbyman</div>
                  </div>
              </figcaption>
          </figure>
          <figure className="max-w-screen-md mx-auto">
              ...
              <figcaption className="flex items-center justify-center mt-6 space-x-3">
                  <div className="flex items-center divide-x-2 divide-[#E73725]">
                      ...
                      <div className="pl-3 text-sm font-semibold text-[#E73725]">Client particulier</div>
                  </div>
              </figcaption>
          </figure>
        </div>
