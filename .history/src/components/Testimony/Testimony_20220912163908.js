    ...
    <section class="w-full my-28" id="temoignage">
      <div class="px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec mauris id quam pharetra sodales et ut justo. Duis sit amet felis dolor. </p>
        </div>
        ...
        <figure class="max-w-screen-md mx-auto">
              ...
              <figcaption class="flex items-center justify-center mt-6 space-x-3">
                  ...
                  <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                      ...
                      <div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-600">CEO at Google</div>
                  </div>
              </figcaption>
          </figure>
          <figure class="max-w-screen-md mx-auto">
              ...
              <figcaption class="flex items-center justify-center mt-6 space-x-3">
                  ...
                  <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                      ...
                      <div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-600">CFO at Facebook</div>
                  </div>
              </figcaption>
          </figure>
          <figure class="max-w-screen-md mx-auto">
