  ...
  return (
    <nav className="flex items-center">
      ...
      <ul className=" md:flex md:gap-10 ml-auto text-[17px] font-semibold ">
        ...
        { openMenu && (
          <div className="absolute right-8 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 rounded-xl w-full p-4 text-center text-[13px] justify-center content-evenly dark:text-gray-100 text-gray-800 font-semibold z-50">
