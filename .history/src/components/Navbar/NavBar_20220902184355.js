  ...
  return (
    <nav className="flex items-center">
      ...
      <ul className=" md:flex md:gap-10 ml-auto text-[18px] font-semibold ">
        ...
        { openMenu && (
          <div className="absolute right-8 dark:bg-gray-400 bg-gray-200 p-8 text-center text-[13px] justify-center content-between dark:text-gray-100 text-gray-800 font-semibold z-50">
