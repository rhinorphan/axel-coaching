  ...
  return (
    <nav className="flex items-center">
      <div className="flex items-center">
        <div className="text-[20px] font-bold cursor-pointer mr-6"><a href='#'>Axel Coaching</a></div>
        <label for="default-toggle" class="inline-flex relative items-center cursor-pointer mr-6">
            ...
            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-gray-700 dark:peer-focus:ring-gray-300 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-gray-500"></div>
      ...
      <ul className=" md:flex md:gap-10 ml-auto text-[18px] font-semibold ">
        ...
        { openMenu && (
          <div className="absolute right-8 dark:bg-gray-400 bg-gray-400 p-8 text-center text-[13px] dark:text-gray-100 text-gray-800 font-semibold z-50">
