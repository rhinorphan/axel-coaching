    ...
    <nav className="flex items-center scroll-smooth mb-5">
      ...
      <ul className=" md:flex md:gap-10 ml-auto text-[15px] lg:text-[18px] font-semibold items-center ">
        { openMenu && isMobile ? (
          ...
          <>
            <li className="hover:text-[#A04738] transition-all duration-300 cursor-pointer"><a href="/">Particulier</a></li>
            <li className="hover:text-[#A04738] transition-all duration-300 cursor-pointer"><a href="/entreprise">Entreprise</a></li>
            <li className="bg-gray-800 dark:bg-[#A04738] shadow-md dark:shadow-dk text-[#FFFFFF] dark:text-white dark:hover:bg-white dark:hover:text-[#A04738] hover:bg-[#A04738] rounded-full py-2 px-3 transition-all duration-300 cursor-pointer ml-16 md:ml-30 lg:ml-56 xl:ml-96"><a href="#contact">Contact</a></li>
          </>
        )}
        { openMenu && (
          <div className="absolute right-8 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 rounded-xl p-4 text-center text-[13px] justify-center content-evenly dark:text-gray-100 text-gray-800 font-semibold z-50">
            <li className="cursor-pointer my-2 hover:text-[#A04738] transition-all duration-300"><a href="/" onClick={handleMenu}>Particulier</a></li>
