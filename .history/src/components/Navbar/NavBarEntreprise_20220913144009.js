      ...
      <ul className=" md:flex md:gap-10 ml-auto text-[15px] lg:text-[18px] font-semibold items-center ">
        { openMenu && isMobile ? (
          ...
          <>
            ...
            <li className="bg-gray-800 dark:bg-[#E73725] shadow-md text-[#FFFFFF] dark:text-white dark:hover:bg-white dark:hover:text-[#E73725] hover:bg-[#E73725] rounded-full py-2 px-3 transition-all duration-300 cursor-pointer ml-16 md:ml-30 lg:60"><a href="#contact">Contact</a></li>
          </>
        )}
        { openMenu && (
