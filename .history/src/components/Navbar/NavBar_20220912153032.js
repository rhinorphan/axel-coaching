  ...
  return (
    <nav className="flex items-center">
      <div className="flex items-center">
        <div className="text-[18px] lg:text-[22px] font-bold cursor-pointer mr-4"><a href='#'>Axel Coaching</a></div>
      ...
      <ul className=" md:flex md:gap-10 ml-auto text-[15px] lg:text-[18px] font-semibold ">
        { openMenu && isMobile ? (
          ...
          <>
            ...
            <li className="hover:text-gray-500 transition-all duration-300 cursor-pointer"><a href="#entreprise">Entreprise</a></li>
            ...
            <li className="hover:text-gray-500 transition-all duration-300 cursor-pointer ml-8 lg:ml-20"><a href="#contact">Contact</a></li>
          </>
        )}
        { openMenu && (
          <div className="absolute right-8 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 rounded-xl p-4 text-center text-[13px] justify-center content-evenly dark:text-gray-100 text-gray-800 font-semibold z-50">
            ...
            <li className="cursor-pointer my-2"><a href="#entreprise" onClick={handleMenu}>Entreprise</a></li>
