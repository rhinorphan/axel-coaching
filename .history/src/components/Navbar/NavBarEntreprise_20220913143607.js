      ...
      <ul className=" md:flex md:gap-10 ml-auto text-[15px] lg:text-[18px] font-semibold items-center ">
        { openMenu && isMobile ? (
          ...
          <>
            ...
            <li className="bg-gray-800 dark:bg-[#E73725] shadow-md text-[#FFFFFF] dark:text-white dark:hover:bg-[#E73725] dark:hover:text-white hover:bg-[#E73725] rounded-full py-2 px-3 transition-all duration-300 cursor-pointer ml-8 lg:ml-20"><a href="#contact">Contact</a></li>
          </>
        )}
        { openMenu && (
