  ...
  return (
    <nav className="flex items-center">
      <div className="flex items-center">
        <div className="text-[18px] font-bold cursor-pointer mr-4"><a href='#'>Axel Coaching</a></div>
      ...
      <ul className=" md:flex md:gap-10 ml-auto text-[15px] font-semibold ">
        { openMenu && isMobile ? (
          ...
          <>
            ...
            <li className="hover:text-gray-500 transition-all duration-300 cursor-pointer ml-8"><a href="#contact">Contact</a></li>
          </>
        )}
        { openMenu && (
