    ...
    <section className="text-center" id='entreprise'>
        <div className="py-8 gap-8 items-center px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div className="mt-10 md:mt-0">
                ...
                <a href="#contact" className="flex items-center bg-gray-800 dark:bg-white shadow-md text-[#FFFFFF] dark:text-[#E73725] dark:hover:bg-[#E73725] dark:hover:text-white hover:bg-[#E73725] rounded-full transition-all duration-300 focus:ring-4 focus:ring-gray-300 font-medium  text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-gray-900 w-44 mx-auto">
                    Ça m’intéresse
