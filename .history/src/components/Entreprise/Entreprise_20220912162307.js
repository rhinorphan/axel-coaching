    ...
    <section class="" id='entreprise'>
        <div class="py-8 gap-8 items-center px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div class="mt-10 md:mt-0 text-justify">
                ...
                <a href="#contact" class="inline-flex items-center text-gray-800 dark:text-white bg-gray-400 dark:bg-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 focus:ring-4 focus:ring-primary-300 font-semibold rounded-full text-sm px-5 py-2.5 text-center dark:focus:ring-gray-900">
                    Ça m’intéresse
