...
const Slogan = () => {
  ...
  return (
    <section className="text-[36px] relative my-14 font-extrabold md:flex md:justify-evenly md:items-center md:text-[43px] h-[70%] md:h-screen">
      ...
      <div className="mt-[100px] relative md:mt-0 flex justify-center md:right-[-5rem]">
        <img src={Trainer} alt="people training" className="hero2 shadow-md max-h-[1000px]" />
      </div>
    </section>
  );
}
