...
const Slogan = () => {
  ...
  return (
    <section className="text-[36px] relative my-8 font-extrabold md:my-8 md:flex md:justify-evenly md:items-center md:text-[48px] h-screen">
      <div className="text-center mt-28 md:mt-0 md:col-span-1 md:col-start-2 min-w-[40%]">
        <p>
