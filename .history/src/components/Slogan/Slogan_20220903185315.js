...
const Slogan = () => {
  ...
  return (
    <section className="text-[36px] relative my-14 font-extrabold md:my-28 md:flex md:justify-evenly md:items-center md:text-[48px] h-screen">
      <div className="text-center mt-40 md:mt-0 md:col-span-1 md:col-start-2 min-w-fit">
        <p>
      ...
      <div className="mt-[100px] relative md:mt-0 flex justify-center md:right-[-5rem]">
        <img src={Trainer} alt="people training" className="hero2 md:max-w-[80%]" />
      </div>
    </section>
  );
}
