  ...
  return (
    <section className="text-[36px] relative my-2 font-extrabold md:flex md:justify-evenly md:items-center md:text-[43px] h-screen">
      <div className="text-center mt-24 md:mt md:mt-0 md:col-span-1 md:col-start-2 md:min-w-[35%] mr-2">
        <p>
          Ne limitez pas  <span className="text-gray-400">vos</span> défis, défiez vos <span className="text-gray-400">limites</span>
        </p>
        <button className="text-[20px] px-6 py-[6px] font-bold mt-[27px] bg-[#E73725] text-[#FFFFFF] dark:hover:bg-gray-500 hover:bg-orange-300 rounded-full">
