...
const Slogan = () => {
  ...
  return (
    <section className="text-[36px] relative my-14 font-extrabold md:my-48 md:flex md:justify-evenly md:items-center md:text-[48px] h-screen md:min-h-screen">
      <div className="text-center mt-40 md:mt-0 md:col-span-1 md:col-start-2">
        ...
        <button className="text-[20px] px-6 py-[6px] font-bold mt-[27px] bg-gray-400 hover:bg-gray-500 rounded-full">
