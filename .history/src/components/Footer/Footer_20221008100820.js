  ...
  return (
    <footer class="text-center">
        ...
        <div class="flex justify-center items-center p-4 mt-14 max-w-3xl mx-auto gap-20">
          <a href="https://www.linkedin.com/in/axel-duchene-28bab9239" class="text-gray-800 dark:text-white hover:text-[#A04738] dark:hover:text-[#A04738]" aria-label="Lien vers mon profile LinkedIn">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
