...
function Footer() {
  return (
    <footer class="text-center">
      ...
      <div className='lg:text-sm text-gray-400'>Created with<span className='mx-1'><SiTailwindcss/></span> by  <a href='https://axeltarifa.dev' className='ml-1'> Axel Tarifa</a></div>
