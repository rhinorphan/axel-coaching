...
function Footer() {
  return (
    <footer class="text-center text-white glassmorphism">
        <div class="flex justify-center text-gray-700 w-full">
      ...
      <div class="text-center text-gray-700 p-4">
        © 2022 Copyright:
        <a class="text-gray-800" href="https://website-axel-coaching.web.app/">Axel Coaching</a>
      </div>
    </footer>
  )
}
