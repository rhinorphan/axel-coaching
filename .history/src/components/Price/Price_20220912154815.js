  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-10">
          ...
          <p class="mt-16 font-light text-gray-500 sm:text-xl dark:text-gray-400">Tarifs solo <span className="text-[30px] md:text-[40px]">🏋️</span></p>
      </div>
      <div class="lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 space-y-5">
          <div class="flex flex-col mx-auto max-w-lg text-center items-center dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md from-white/60 to-transparent rounded-2xl p-4 xl:p-8 h-fit">
          ...
          <div class="flex flex-col mx-auto max-w-lg text-center items-center shadow-md from-white/60 to-transparent rounded-2xl xl:p-8 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75">
          ...
          <div class="flex flex-col mx-auto max-w-lg text-center shadow-md from-white/60 to-transparent rounded-2xl items-center xl:p-8 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75">
      ...
      <div class="mx-auto max-w-screen-md text-center mb-10 space-y-10">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Pensé pour <span className="text-gray-400">vous</span></h2>
          <p class="mt-16 font-light text-gray-500 sm:text-xl dark:text-gray-400">Tarifs solo <span className="text-[30px] md:text-[40px]">🏋️</span></p>
      </div>
      <div class="lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 ">
          <div class="flex flex-col mx-auto max-w-lg text-center items-center dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md from-white/60 to-transparent rounded-2xl xl:p-8 h-fit">
              <h3 class="mb-4 text-2xl font-semibold">Forfait à la séance</h3>
              <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Orci varius natoque penatibus et magnis dis parturient montes.</p>
              <div class="flex justify-center items-baseline">
                  <span class="mt-8 text-5xl font-extrabold">50€</span>
