  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-10">
          ...
          <p class="mt-16 font-light text-gray-500 text-xl md:text-2xl dark:text-gray-400">Tarifs solo <span className="text-[30px] md:text-[40px] ml-1">🏋️</span></p>
      </div>
      ...
      <div class="mx-auto max-w-screen-md text-center mb-10">
          <p class="mt-16 font-light text-gray-500 text-xl md:text-2xl dark:text-gray-400">Tarifs duo <span className="text-[30px] md:text-[40px] ml-1">🤼</span></p>
      </div>
      <div class="lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 space-y-10 lg:space-y-0">
          <div class="flex flex-col mx-auto max-w-lg text-center items-center dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md from-white/60 to-transparent rounded-2xl p-4 lg:p-8 h-fit">
              <h3 class="mb-4 text-2xl font-semibold">Forfait à la séance</h3>
          ...
          <div class="flex flex-col mx-auto max-w-lg text-center shadow-md from-white/60 to-transparent rounded-2xl items-center p-4 lg:p-8 dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75">
              ...
              <p class="mb-8 text-gray-500 dark:text-gray-400 text-xs">(soit 30 euros / personne)</p>
              <a href="#contact" class="dark:hover:text-gray-800 bg-gray-400 dark:hover:bg-gray-500 hover:bg-gray-200 rounded-full  hover:text-gray-700 transition-all duration-300 focus:ring-4 focus:ring-gray-300 font-medium text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">C'est partis !</a>
          </div>
      </div>
  </div>
