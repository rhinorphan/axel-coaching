    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
      ...
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md from-white/60 to-transparent rounded-2xl xl:p-8 h-fit">
              ...
              <a href="#contact" class="text-gray-800 bg-gray-400 dark:hover:bg-gray-500 hover:bg-gray-300 rounded-full dark:hover:text-gray-800 hover:text-gray-200 transition-all duration-300 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">C'est partis !</a>
          </div>
