  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
      ...
      <div class="lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10">
          ...
          <div class="flex flex-col mx-auto max-w-lg text-center shadow-md from-white/60 to-transparent rounded-2xl items-center dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75">
