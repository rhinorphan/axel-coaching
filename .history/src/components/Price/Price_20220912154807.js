  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-6">
      ...
      <div class="lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 space-y-5">
          <div class="flex flex-col mx-auto max-w-lg text-center items-center dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md from-white/60 to-transparent rounded-2xl p-2 xl:p-8 h-fit">
