...
function Contact() {
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md dark:glassmorphism rounded-2xl backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md md:px-6">
      ...
      <form action="#" class="space-y-8" ref={form} onSubmit={sendEmail}>
          ...
          <button type="submit" class="py-3 px-5 text-sm font-bold text-center bg-gray-800 dark:bg-white shadow-md text-[#FFFFFF] dark:text-[#E73725] dark:hover:bg-[#E73725] dark:hover:text-white hover:bg-[#E73725] rounded-full transition-all duration-300 max-w-lg mx-auto button">Envoyer</button>
      </form>
  </div>
</section>
  )
