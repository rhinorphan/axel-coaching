...
function Contact() {
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md dark:glassmorphism backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md">
      ...
      <form action="#" class="space-y-8" ref={form} onSubmit={sendEmail}>
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium text-center dark:text-gray-100text-gray-800 rounded-lg text-gray-800 bg-gray-400 dark:hover:bg-gray-500 hover:bg-gray-200  dark:hover:text-gray-800 hover:text-gray-700 transition-all duration-300 sm:w-fit">Envoyer</button>
      </form>
  </div>
</section>
  )
