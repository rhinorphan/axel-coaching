...
function Contact() {
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md dark:glassmorphism rounded-2xl backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md md:px-6">
      ...
      <form action="#" class="space-y-8" ref={form} onSubmit={sendEmail}>
          ...
          <div>
              <label for="email" class="block mb-2 text-sm font-medium text-[#E73725]">Votre e-mail</label>
          ...
          <div>
              <label for="phone" class="block mb-2 text-sm font-medium text-[#E73725]">Votre numéro de téléphone</label>
          ...
          <div class="sm:col-span-2">
              <label for="message" class="block mb-2 text-sm font-medium text-[#E73725]">Votre message</label>
