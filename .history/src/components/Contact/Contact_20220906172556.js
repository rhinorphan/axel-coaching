...
function Contact() {
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md dark:glassmorphism rounded-2xl backdrop-blur-lg backdrop-opacity-100 backdrop-contrast-75 shadow-md px-6">
