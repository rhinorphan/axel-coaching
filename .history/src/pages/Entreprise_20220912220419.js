...
function Entreprise() {
  ...
  return (
    <div className="font-sora px-4 py-3 overflow-y-auto overflow-x-hidden bg-gradient-to-b from-white via-slate-50 dark:from-gray-900 to-gray-100 dark:to-gray-900 text-gray-800 dark:text-white scroll-smooth">
      ...
      <Hero />
      <div className="py-8 gap-8 items-center px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6" id='entreprise'>
        <img className="w-full rounded-lg hero2 shadow-md" src={Team} alt="Team Work" />
        <div className="mt-10 md:mt-0">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Pourquoi le coaching en <span className='text-[#E73725]'>entreprise </span>?</h2>
