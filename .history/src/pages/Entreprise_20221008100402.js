    ...
    <div className="font-sora px-4 py-3 overflow-y-auto overflow-x-hidden bg-[#F5F4F2] dark:bg-gray-900 text-gray-800 dark:text-white scroll-smooth">
      ...
      <div className="py-8 gap-8 items-center px-4 mx-auto max-w-screen-2xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6 text-center" id='entreprise'>
        ...
        <div className="mt-10 md:mt-0">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-800 dark:text-white">Pourquoi le coaching en <span className='text-[#A04738]'>entreprise </span>?</h2>
          ...
          <a href="#contact" className="flex items-center bg-gray-800 dark:bg-[#A04738] shadow-md dark:shadow-dk text-[#FFFFFF] dark:text-white dark:hover:bg-white dark:hover:text-[#A04738] hover:bg-[#A04738] rounded-full transition-all duration-300 font-medium  text-sm px-5 py-2.5 text-center w-44 mx-auto" aria-label='Lien vers le formulaire de contact'>
            Ça m'intéresse
