    ...
    <div className="font-sora px-4 py-3 overflow-y-auto overflow-x-hidden bg-gradient-to-b from-white via-slate-50 dark:from-gray-900 to-gray-100 dark:to-gray-900 text-gray-800 dark:text-white scroll-smooth">
      ...
      <div className="py-8 gap-8 items-center px-4 mx-auto max-w-screen-2xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6 text-center" id='entreprise'>
        ...
        <div className="mt-10 md:mt-0">
          ...
          <a href="#contact" className="flex items-center bg-gray-800 dark:bg-[#E73725] shadow-md text-[#FFFFFF] dark:text-white dark:hover:bg-white dark:hover:text-[#E73725] hover:bg-[#E73725] rounded-full transition-all duration-300 font-medium  text-sm px-5 py-2.5 text-center w-44 mx-auto">
            Ça m’intéresse
