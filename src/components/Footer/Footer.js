  ...
  return (
    <footer class="text-center">
        <div className='flex justify-center'>
          <a href="https://www.servicesalapersonne.gouv.fr/" className='cursor-pointer' aria-label="Plus d'information sur le service à la personne">
            <img src={Img} alt="" className='w-48' />
          </a>
        </div>
        <div class="flex justify-center items-center p-4 mt-14 max-w-3xl mx-auto gap-20">
          <a href="https://www.linkedin.com/in/axel-duchene-28bab9239" class="text-gray-800 dark:text-white hover:text-[#E73725] dark:hover:text-[#E73725]" aria-label="Lien vers mon profile LinkedIn">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
      ...
      <div class="flex justify-center text-md mx-auto max-w-3xl font-semibold mt-2">
        © 2022 Copyright :
        <a class="font-bold hover:text-[#E73725] ml-1" href="/"> Axel Coaching</a>
      </div>
