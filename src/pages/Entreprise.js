import '../App.css'
import NavBarEntreprise from '../components/Navbar/NavBarEntreprise';
...
function Entreprise() {
  ...
  return (
    <div className="font-sora px-4 py-3 overflow-y-auto overflow-x-hidden bg-gradient-to-b from-white via-slate-50 dark:from-gray-900 to-gray-100 dark:to-gray-900 text-gray-800 dark:text-white scroll-smooth">
      ...
      <div className="py-8 gap-8 items-center px-4 mx-auto max-w-screen-2xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6 text-center" id='entreprise'>
        ...
        <div className="mt-10 md:mt-0">
          ...
          <br/><br/>
          Les coachings se déroulent au sein de vos locaux ou dans un espace extérieur proche. Le matériel est pris en charge par le coach. Cette offre vous intéresse ? Contactez-moi par mail en précisant l'adresse de l'entreprise, le nombre de collaborateurs et le nombre de cours souhaités (ou le temps d'intervention). Un devis vous sera fourni sous 48 h.</p>
          <a href="#contact" className="flex items-center bg-gray-800 dark:bg-[#E73725] shadow-md dark:shadow-dk text-[#FFFFFF] dark:text-white dark:hover:bg-white dark:hover:text-[#E73725] hover:bg-[#E73725] rounded-full transition-all duration-300 font-medium  text-sm px-5 py-2.5 text-center w-44 mx-auto" aria-label='Lien vers le formulaire de contact'>
            Ça m'intéresse
